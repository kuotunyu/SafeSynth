"""Freeze exact v7 owner-review files before presenting them."""

from __future__ import annotations

import json

from scripts.record_supervised_labeler_v7_review import (
    REVIEW_MANIFEST_PATH,
    build_v7_registration,
)
...
def main() -> None:
    if REVIEW_MANIFEST_PATH.exists():
        raise RuntimeError("v7 owner-review manifest is already frozen")
    ...
    payload = {
        "schema_version": 1,
        "status": "v7_owner_review_files_frozen",
