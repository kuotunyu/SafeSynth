"""Freeze and render the independent v23 GT-only review pool."""
...
POOL_PATH = PROJECT_ROOT / "splits" / "supervised_labeler_v23_gt_pool.json"
EVIDENCE_PATH = (
...
FIGURE_DIR = (
    ...
    / "reports"
    / "figures"
    / "supervised_labeler_v23_gt_review"
)
