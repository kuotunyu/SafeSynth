...
- Audited HEAD: `1dc774b66ead446eb49fc5383b1f9992b2ef2052`
- Commits across all local refs: **249**
...
- H4 scale-up gate: **FAIL** (AUC 0.9053; maximum 0.60)
...
- H4 AUC 0.9053 (delivered pool, 106144 patches) exceeds the 0.60 maximum: paste artifacts are detectable. Accepted as a reported limitation per ADR-011; generation is capped at 1x and 2x is forbidden. Every result table must display this AUC. M11 pre-registration measured 0.7964 on 300 images.
